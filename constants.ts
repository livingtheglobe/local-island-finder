...
export const ISLANDS: Island[] = [
  ...
  },
  {
    ...
    descriptionDe: 'Nur 45 Minuten mit dem Schnellboot von Malé entfernt, bietet Guraidhoo als mittelgroße Einheimischen-Insel einen authentischen Einblick in das Inselleben. Sie ist eine der wenigen Inseln in der Nähe, die direkt mit der öffentlichen Fähre erreichbar ist – perfekt für Budget-Reisende. Die Insel selbst ist nicht sehr grün, liegt aber am nächsten für Schildkröten-Schnorcheltouren. Für Ammenhaie und Mantarochen fahren die meisten Boote etwa 45 Minuten weiter Richtung Vaavu-Atoll.',
  ...
  },
  {
    ...
    descriptionDe: 'Diese kleine, fröhliche Insel liegt nur 30 Minuten mit dem Schnellboot von Malé entfernt und ist auch mit der öffentlichen Fähre erreichbar. Bekannt für ihre türkisfarbene Lagune und die fotogene Strandschaukel. Die Insel hat eine entspannte, gesellige Atmosphäre, ist aber nie überlaufen. Für Hai- oder Manta-Ausflüge fahren die meisten Boote etwa 45 Minuten hinaus zum Vaavu-Atoll.',
  ...
  // --- NORTH MALÉ ATOLL ---
  {
    ...
    descriptionDe: 'Die Surfhauptstadt der Malediven, nur 30 Minuten mit dem Schnellboot von Malé oder per öffentlicher Fähre erreichbar. Diese große, actionreiche Insel ist bei Surfern und Backpackern gleichermaßen beliebt. Wenig Grün, aber viel Energie: tolle Wellen, lebhafte Gästehäuser, stilvolle Cafés und eine schwimmende Bar vor der Küste. Perfekt für alle, die eine gesellige Atmosphäre mit einem Hauch von Abenteuer suchen.',
  ...
  },
  {
    ...
    descriptionDe: 'Die östlichste Einheimischen-Insel der Malediven, 45 Minuten per Schnellboot von Malé oder per Fähre erreichbar. Dhiffushi bietet viel: drei Bikini-Strände, Unmengen an Wassersport und eine angenehm gesellige Atmosphäre. Wenig Vegetation, aber die Vielfalt an Gästehäusern, Strandcafés und Ausflugsmöglichkeiten macht sie zu einer unterhaltsamen und bequemen Wahl für einen Kurztrip.',
  ...
  },
  {
    ...
    descriptionDe: 'Eine ruhige Surf-Insel, nur 20 Minuten per Schnellboot vom Flughafen Malé (auch per Fähre erreichbar). Diese mittelgroße Insel hat eine entspannte, unaufgeregte Atmosphäre mit wenig Grün, aber viel lokalem Flair. Beliebt bei Surfern, aber auch Nicht-Surfer schätzen die leeren Straßen, das gemächliche Tempo und das überraschend gute Essen. Eine tolle Wahl für Ruhe und Einfachheit in der Nähe der Hauptstadt.',
  ...
  // --- VAAVU ATOLL ---
  {
    ...
    descriptionDe: 'Etwas über eine Stunde mit dem Schnellboot von Malé (oder per Direktfähre), ist Fulidhoo eine friedliche, mittelgroße Insel mit authentischem Flair. Sie liegt am nächsten zum berühmten Ammenhai-Spot, und oft sieht man freundliche Stachelrochen direkt am Strand. Wenig Vegetation, aber einige Hotels bieten Pools für etwas mehr Komfort.',
  ...
  },
  {
    ...
    descriptionDe: 'Diese kleine Insel fühlt sich an wie ein verstecktes Resort, aber ohne die hohen Preise. Erreichbar in ca. 1,5 Stunden per Schnellboot oder Fähre. Thinadhoo bietet eine friedliche Atmosphäre, üppige Dschungelpfade und einen der breitesten Bikini-Strände der Einheimischen-Inseln. Vor der Küste gibt es sogar eine schwimmende Bar für den Drink zum Sonnenuntergang.',
  ...
  },
  {
    ...
    videoUrl: 'https://youtu. shellfishXqMAT0cy_dY',
