...
export const ISLANDS: Island[] = [
  // --- SOUTH MALÉ ATOLL ---
  {
    ...
    descriptionDe: 'Eine der beliebtesten Einheimischen-Inseln, nur 30 Minuten mit dem Schnellboot von Malé oder direkt mit der öffentlichen Fähre erreichbar. Bekannt für ihre lebhafte Atmosphäre, unzählige Ausflüge und eine große Auswahl an Unterkünften. Maafushi hat wenig Grün, bietet aber endlose Aktivitäten. Wassersport, Bootstouren und Strandcafés sorgen für eine gesellige, energiegeladene Stimmung. Die meisten Hai- und Manta-Touren fahren etwa 45 Minuten zum Vaavu-Atoll, aber an Optionen mangelt es hier nicht. Ideal für alle, die Komfort, Spaß und Abwechslung suchen.',
