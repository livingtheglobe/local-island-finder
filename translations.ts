...
export const UI_TEXT = {
  en: {
    ...
    exploreTitle: "Explore Local Islands",
    showingResults: "Showing {count} results based on your preferences",
  ...
  de: {
    ...
    exploreTitle: "Lokale Inseln entdecken",
    showingResults: "Zeige {count} Ergebnisse basierend auf Ihren Vorlieben",
